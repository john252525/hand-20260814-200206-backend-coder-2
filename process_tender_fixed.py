# Исправленный process_tender.py с try/except и обновлением Task
import asyncio
    ...
    async with AsyncSessionLocal() as db:
        ...
        for cat in categories:
            if cat.embedding and any(x != 0 for x in cat.embedding):
                ...
                # Fallback: совпадение по ключевым словам (не менее 2 значимых слов)
