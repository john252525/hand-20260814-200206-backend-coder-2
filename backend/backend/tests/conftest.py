...
async def setup_db():
    ...
    async with AsyncSessionLocal() as db:
        ...
        await db.execute(sa_text("TRUNCATE idempotency_keys RESTART IDENTITY"))
        await db.execute(sa_text("TRUNCATE api_tokens RESTART IDENTITY"))
        await db.execute(sa_text("TRUNCATE settings RESTART IDENTITY"))
        await db.commit()
